...
class NickWrapper implements EWrapper {
    public static final int NOT_AN_FA_ACCOUNT_ERROR = 321 ;
    public int faErrorCodes[] = { 503, 504, 505, 522, 1100, NOT_AN_FA_ACCOUNT_ERROR } ;
    ...
    void onHistoricalData() {
        ...
        if( Util.StringCompare( m_orderDlg.m_whatToShow, "estimates" ) == 0 ||
        	...
        	m_client.reqFundamentalData(m_orderDlg.m_id, m_orderDlg.m_contract,
        			 m_orderDlg.m_whatToShow); // report type
        	return;
        }
